...
-- Add blinking to all modes. Cursor coloring is left to the terminal
-- (Windows Terminal / Ghostty both paint it from their own scheme), so no
-- Cursor/lCursor highlight groups and no OSC 12 emission from nvim.
...
-- Disable unused language providers (faster startup, clean :checkhealth)
